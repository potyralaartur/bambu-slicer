...
const SECTIONS: readonly SectionSpec[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { kind: "dropdown", id: "support_base_pattern", label: "Base pattern", options: ["Default", "Rectilinear", "Rectilinear grid", "Honeycomb", "Lightning", "Hollow"], defaultValue: "Default", showPattern: true },
      ...
      { kind: "dropdown", id: "support_interface_pattern", label: "Interface pattern", options: ["Default", "Rectilinear", "Concentric", "Rectilinear Interlaced", "Grid"], defaultValue: "Default", showPattern: true },

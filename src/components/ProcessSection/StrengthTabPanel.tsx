...
const SECTIONS: readonly SectionSpec[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { kind: "dropdown", id: "top_surface_pattern", label: "Top surface pattern", options: SURFACE_PATTERN_OPTIONS, defaultValue: "Rectilinear" },
      ...
      { kind: "dropdown", id: "bottom_surface_pattern", label: "Bottom surface pattern", options: SURFACE_PATTERN_OPTIONS, defaultValue: "Rectilinear" },
      ...
      { kind: "dropdown", id: "internal_solid_infill_pattern", label: "Internal solid infill pattern", options: SURFACE_PATTERN_OPTIONS, defaultValue: "Rectilinear" },
    ],
  },
  {
    title: "Sparse infill",
    fields: [
      ...
      { kind: "dropdown", id: "sparse_infill_pattern", label: "Sparse infill pattern", options: SPARSE_INFILL_PATTERN_OPTIONS, defaultValue: "Cubic" },
      { kind: "dropdown", id: "locked_skin_infill_pattern", label: "Skin infill pattern", options: LOCKED_INFILL_PATTERN_OPTIONS, defaultValue: "Cross Zag", visibleWhen: isLockedZag },
      ...
      { kind: "dropdown", id: "locked_skeleton_infill_pattern", label: "Skeleton infill pattern", options: LOCKED_INFILL_PATTERN_OPTIONS, defaultValue: "Zig Zag", visibleWhen: isLockedZag },
